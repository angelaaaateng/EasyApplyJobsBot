...
class Linkedin:
    def __init__(self):
        ...
        self.cookies_path = os.path.join(os.getcwd(), 'cookies', f"{self.getHash(config.email)}.pkl")
        ...
        if not self.isLoggedIn():
            ...
            try:    
                ...
                utils.prRed("❌ Couldn't log in Linkedin by using Chrome. Please check your Linkedin credentials in the config file on lines 7 and 8.")
    ...
    def generateUrls(self):
        ...
        try:
            ...
            utils.prRed("❌ Couldn't generate urls, make sure you have edited the config file on lines 25-39")
    ...
    def getJobProperties(self, count):
        ...
        try:
            companyName = self.driver.find_element(By.XPATH, "/html/body/div[5]/div[3]/div[2]/div/div/main/div/div[1]/div/div[1]/div/div/div[1]/div[1]/div/div/a").get_attribute("innerText").strip()
        except:
            companyName = "cannot get company name"

        try:
            # jobTitle = self.driver.find_element(By.XPATH, "//h1[contains(@class, 'job-title')]").get_attribute("innerHTML").strip()
            jobTitle = self.driver.find_element(By.XPATH, "/html/body/div[5]/div[3]/div[2]/div/div/main/div/div[1]/div/div[1]/div/div/div[1]/div[2]/div/h1").get_attribute("innerHTML").strip()
        ...
        textToWrite = str(count) + " | " + companyName + " | " + jobTitle + " | " + jobDetail + " | " +  jobLocation
        return textToWrite
